...
public class ConfigurationModule : Module {
    protected override void Load(ContainerBuilder builder) {
        ...
        builder.Register(c => c.Resolve<IConfigFactory>().Create<WalletSettings>()).AsSelf().SingleInstance();
        ...
        builder.Register(c => c.Resolve<IConfigFactory>().Create<AccountUbikiriConfig>()).AsSelf().SingleInstance();
    }
}