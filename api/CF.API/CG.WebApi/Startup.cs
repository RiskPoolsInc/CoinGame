...
public class Startup
{
    ...
    public void ConfigureContainer(ContainerBuilder builder)
    {
        ...
        builder.RegisterType<UbikiriWalletService>().SingleInstance();
