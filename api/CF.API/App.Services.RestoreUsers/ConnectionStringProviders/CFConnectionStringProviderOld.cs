...
public class CFConnectionStringProviderOld : IConnectionStringProvider {
    public const string CONNECTION_KEY = "CFAppDbContextOld";

    private readonly IDictionary<string, string> _connections;

    public CFConnectionStringProviderOld(IConfiguration configuration) {
