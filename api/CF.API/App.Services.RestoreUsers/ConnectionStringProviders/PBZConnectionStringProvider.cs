...
public class PBZConnectionStringProvider : IConnectionStringProvider {
    public const string CONNECTION_KEY = "PBZAppDbContext";

    private readonly IDictionary<string, string> _connections;

    public PBZConnectionStringProvider(IConfiguration configuration) {
