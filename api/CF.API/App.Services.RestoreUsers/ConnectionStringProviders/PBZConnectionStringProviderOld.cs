...
public class PBZConnectionStringProviderOld : IConnectionStringProvider {
    public const string CONNECTION_KEY = "PBZZAppDbContextOld";

    private readonly IDictionary<string, string> _connections;

    public PBZConnectionStringProviderOld(IConfiguration configuration) {
