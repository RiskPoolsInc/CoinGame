...
{
    public static class FillBasePbzDictionaries
    {
        public static void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(FillBaseDictionaries.InsertMFATypes(!migrationBuilder.IsNpgsql()));
            migrationBuilder.Sql(FillBaseDictionaries.InsertCurrencies(!migrationBuilder.IsNpgsql()));
            migrationBuilder.Sql(FillBaseDictionaries.InsertCountries);
            migrationBuilder.Sql(FillBaseDictionaries.InsertCountryStates);
            migrationBuilder.Sql(FillBaseDictionaries.InsertLocales);
            migrationBuilder.Sql(FillBaseDictionaries.InsertObjectTypes);
            migrationBuilder.Sql(FillBaseDictionaries.InsertTaskTypes);
            migrationBuilder.Sql(FillBaseDictionaries.InsertAuditEventTypes);
            migrationBuilder.Sql(FillBaseDictionaries.InsertTaskActionTypes);
            migrationBuilder.Sql(FillBaseDictionaries.InsertTaskStateTypes);
            migrationBuilder.Sql(FillBaseDictionaries.InsertFollowTypes);
            migrationBuilder.Sql(FillBaseDictionaries.InsertTaskStateGroupTypes);
...
";
 ...
 ";
        ...
        {
            return CommandInsertInto(isSql, InsertMFATypesInfo.Table, VariablesNames, InsertMFATypesInfo.Query, schemaName);
        }

        private static class InsertMFATypesInfo
        {
            internal static string Table = "MultiFactorAuthTypes";

            internal static string Query = @"VALUES 
(1, 'None', 'None'), 
(2, 'Email', 'Email')";
        }
        ...
        {
            return CommandInsertInto(isSql, InsertCurrenciesInfo.Table, new[] {"Id", "Code", "Name"}, InsertCurrenciesInfo.Query,
                schemaName);
        }
        ...
        {
            internal static string Table = "Currencies";
...
";
        ...
        public const string InsertTaskStateTypesCanceled = @"
DO
$do$
BEGIN
   IF NOT EXISTS (SELECT * FROM ""TaskStateTypes"" WHERE ""Id""=5) THEN
            INSERT INTO ""TaskStateTypes""(""Id"", ""Name"", ""Code"") VALUES (5, 'Canceled', 'Canceled');
END IF;
END
$do$
";
...
";
        ...
        public const string InsertTaskFirstRegistrationTypes = @"
...
VALUES
 ...
 ,(2, 'AuditLog', 'AuditLog')";
        ...
        public const string InsertObjectTypesFileAttachment = @"
INSERT INTO ""ObjectTypes""(""Id"", ""Name"", ""Code"") 
VALUES (3, 'TaskExecutionNote', 'TaskExecutionNote');";

        public const string InsertObjectTypesExecution_User = @"
INSERT INTO ""ObjectTypes""(""Id"", ""Name"", ""Code"")
VALUES
...
";
        ...
        public const string InsertAuditEventTypesTaskActivated = @"
INSERT INTO ""AuditEventTypes""(""Id"", ""Name"", ""Code"")
VALUES
 (10, 'Task Execution Created', 'TaskExecutionCreated')
,(11, 'Task Execution Changed', 'TaskExecutionChanged')
,(12, 'Task Activated', 'TaskActivated')
";

        //        TaskExecutionCreated = 10,
        // TaskExecutionChanged = 11,
        //     
        // TaskActivated = 12
        //
...
";
        ...
        #region InsertAttachmentTypes

        public const string InsertAttachmentTypes = @"
INSERT INTO ""AttachmentTypes""(""Id"", ""Name"", ""Code"")
VALUES
 (1, 'File', 'File')
,(2, 'Image', 'Image')
,(3, 'Link', 'Link')
";
        ...
        #region InsertRequiredAttachmentTypes

        public const string InsertRequiredAttachmentTypes = @"
INSERT INTO ""RequiredAttachmentTypes""(""Id"", ""Name"", ""Code"")
VALUES
 (1, 'File', 'File')
,(2, 'Image', 'Image')
,(3, 'Link', 'Link')
...
";
        ...
        #region TaskExecutionsStates

        public const string InsertTaskExecutionStates = @"
INSERT INTO ""TaskExecutionStates""(""Id"", ""Name"", ""Code"")
VALUES
 (1, 'Created', 'Created')
...
";
        ...
        #region TaskExectuionsStatuses

        public const string InsertTaskExecutionStatuses = @"
    INSERT INTO ""TaskExecutionStatuses""(""Id"", ""Name"", ""Code"")
    VALUES
     (1, 'Created', 'Created')
    ,(2, 'In Progress', 'InProgress')
    ,(3, 'Closed', 'Closed')
    ";
        ...
        public static string InsertObjectValueTypes = @"
INSERT INTO ""ObjectValueTypes""(""Id"", ""Name"", ""Code"")
VALUES
 (1, 'Boolean', 'Boolean')
,(2, 'Integer', 'Integer')
,(3, 'Double', 'Double')
...
";
        ...
        public static string InsertPropertyTypes = @"
INSERT INTO ""PropertyTypes""(""Id"", ""Name"", ""Code"")
VALUES
 (1, 'State', 'State')
...
";
        ...
        #region ChangeReasons

        public static string InsertChangeReasonTypes = @"
INSERT INTO ""ChangeReasonTypes""(""Id"", ""Name"", ""Code"")
VALUES
 (1, 'User', 'User')
,(2, 'System', 'System')
";
...
";
        ...
        #region Add Crowdfeeding Base User

        public const string InsertBaseCrowdfeedingUser = @"
INSERT INTO ""Users""(
    ""Id"", ""CreatedOn"", ""UpdatedOn"", ""Email"", ""FirstName"", ""LastName"", ""ImageFileName"", ""IsActive"", ""Password"", ""Salt"", ""MFATypeId"", ""UserTypeId"", ""CountryId"", ""CountryStateId"")
    VALUES ('00000000-0000-0000-0000-000000000004', CURRENT_DATE, CURRENT_DATE, 'admin@crowdfeeding.com', 'Admin', 'Crowdfeeding', null, true, 
            '',
            '0F51eBH1IpPOLn5kXnNnd6+Scu8KmTw7TEFQj/sXSskOONSPzSNK71G7+uS4T8sy1sFVYPR0ks3Y+RSuGza61w==', 
            1, 1, null, null);
";
        ...
        #region ChatObjectTypes

        public const string InsertChatObjectTypes = @"
    INSERT INTO ""ChatObjectTypes"" (""Id"", ""Name"", ""Code"")
    VALUES(1,'Task Execution','TaskExecution');";
