...
public class ApiClient {
    ...
    public async Task<(HttpStatusCode StatusCode, TOut Responce)> PostAsync<TOut>(object            message, string path,
    ...
    protected async Task<(HttpStatusCode, TOut)> DoAsync<TOut>(object message, string path,
