...
export const DO_MORE_LIST: Array<IDoMoreCard> = [
  {
    logo: "git.svg",
    context:
      "311x_<br class='xl-hide lg-hide md-hide'>Explore on GitHub Risk models, scripts for randomness verification, and articles.",
  },
  {
    logo: "x.svg",
    context:
  ...
  },
  {
    logo: "ubix_ex.svg",
    context:
      "313x_<br class='xl-hide lg-hide md-hide'>Buy tokens Buy the tokens of any of our RiskPools.",
  },
  {
    logo: "ubix_stake.svg",
    context:
